...
PairStyle(table/dpd,PairTableDPD)

#else

#ifndef LMP_PAIR_TABLE_DPD_H
#define LMP_PAIR_TABLE_DPD_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTableDPD : public Pair {
 public:
  PairTableDPD(class LAMMPS *);
  virtual ~PairTableDPD();
 ...
 protected:
  ...
  struct Table {
    ...
    double rlo,rhi,fplo,fphi,cut, pplo, pphi, vplo, vphi;
    double *rfile,*efile,*ffile,*pfile,*vfile;
    double *e2file,*f2file, *p2file, *v2file;
    double innersq,delta,invdelta,deltasq6;
    double *rsq,*drsq,*e,*de,*f,*df,*e2,*f2,*v,*dv,*p,*dp,*v2,*p2;
  };
  int ntables;
  Table *tables;
  class RanMars *random;
  double T; //Temperature
  double langevinFriction; // LangevinFriction
